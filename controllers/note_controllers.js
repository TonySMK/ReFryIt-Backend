...
const noteGetAllForAHighlight = (req, res) => {
...
const noteGetOneForAHighlight = (req, res) => {
...
const noteUpdateContent = (req, res) => {
...
module.exports = {
  noteGetAll,
  noteGetAllForAHighlight,
  noteGetOneForAHighlight,
  noteUpdateContent,
  noteDeteleOne,
};
